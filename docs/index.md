...
- [Repo Sandbox Bootstrap Implementation TODO](specs/repo-sandbox-bootstrap-implementation-todo.md) - Detailed build checklist for repo-scoped baselines, private Git bootstrap, and attach handoff.
